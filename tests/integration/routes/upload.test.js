...
describe("Upload API Integration Tests", () => {
  ...
  //     const upload1 = await createUpload({ ...uploadData1 });
  //     const upload2 = await createUpload({ ...uploadData2 });
  ...
  //     const testUpload = await createUpload({ ...uploadTestData });
  ...
  //   });
  // });
  // describe("Update and Delete Uploads", () => {
  //   it("should edit an existing upload PATCH", async () => {
  //     // Find an existing upload (assuming it exists)
  //     const uploadToUpdate = await findUploadByProperty("name", "upload name");

  //     // If a upload with the specified name exists, update it
  //     const response = await agent
  //       .patch(`${uploadTestBaseUrl}/${uploadToUpdate._id}`)
  ...
  //     //   updatedUploadData.description,
  //     // );
  //   });
  //   it("should delete a upload DELETE", async () => {
  //     const uploadToDelete = await findUploadByProperty("name", "upload name");
